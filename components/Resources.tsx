...
const Resources = () => {
  const resources: Resource[] = [
    { name: "Chair's Handbook", file: "/Chair_Handbook.pdf", type: "pdf" },
    { name: "Senior Delegate Allocation", file: "/SeniorDelegateAllocations.pdf", type: "pdf" },
    { name: "Junior Delegate Allocation", file: "/JuniorDelegateAllocations.pdf", type: "pdf" },
    { name: "Rules of Procedures", file: "/RulesOfProcedure.pdf", type: "pdf" },
    { name: "Download NewMUN Logo", file: "NewMUNR.png", type: "image" },
  ]
